        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header <?= lang('app.bgList') ?>">
                    ...
                    <div class="job-badge"><a href="/penerima/input" class="btn <?= $btnclascr ?>" <?= $actcreate ?>><?= $btntextcr ?></a></div>
                </div>
                <!--  -->
                        ...
                        <div class="col-sm-4">
                            <select id="kategori" class="js-example-basic-single" name="kategori">
                                ...
                                <?php foreach ($kategori as $db) : ?>
                                    <option value="<?= $db->kategori ?>" <?= ((session()->getFlashdata('kate') == $db->kategori || $kategori[0]->kategori == $db->kategori) ? 'selected' : '') ?>><?= $db->kategori ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
