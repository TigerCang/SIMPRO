            ...
            <div class="card">
                ...
                <div class="card-block mt-2">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="kode" class="col-sm-1 col-form-label" <?= $khid ?>><?= lang('app.kode') ?></label>
                        <div class="col-sm-2" <?= $khid ?>>
                            <input type="text" harusisi class="form-control text-uppercase" id="kode" name="kode" maxlength="5" placeholder="<?= lang('app.harusisi') ?>" value="<?= ($divisi[0]->kode ?? '') ?>">
                    ...
                    <div class="form-group row" <?= $khid ?>>
                        <label for="nilai" class="col-sm-1 col-form-label"><?= lang('app.hari') ?></label>
                        <div class="col-sm-1">
                            <input type="number" harusisi class=" form-control" id="nilai" name="nilai" placeholder="<?= lang('app.harusisi') ?>" value="<?= ($divisi[0]->nilai ?? '0') ?>" min="0" max="356">
                        </div>
                        <label for="satuan" class="col-sm-1 col-form-label">&ensp;<?= ucfirst(lang('app.hari')) ?></label>
                        <div class="col-sm-6"></div>
                        <label for="potongcuti" class="col-sm-1 col-form-label"><?= lang('app.potongcuti') ?></label>
                        <div class="col-sm-1"><input type="checkbox" id="potcuti" name="potcuti" data-toggle="toggle" <?= (($divisi && $divisi[0]->setdef == '1') ? 'checked' : '') ?> data-on="<?= lang('app.ya') ?>" data-off="<?= lang('app.no') ?>" data-onstyle="success" data-offstyle="light"></div>
                    </div>
                </div>
                <!--  -->
