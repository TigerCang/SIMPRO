                        ...
                        <table id="tabelawal" class="table table-striped table-hover nowrap">
                            <thead>
                                <tr class="bghead">
                                    ...
                                    <th scope="col" width="70" <?= $khid ?>><?= lang('app.kode') ?></th>
                                    <th scope="col"><?= lang('app.deskripsi') ?></th>
                                    <th scope="col" width="70" class="text-center" <?= $khid ?>><?= lang('app.hari') ?></th>
                                    <th scope="col" width="70" class="text-center" data-orderable="false" <?= $khid ?>><?= lang('app.potongcuti') ?></th>
                            ...
                            <tbody>
                                ...
                                foreach ($divisi as $row) :
                                    ...
                                    <tr <?= ($row->xlog == null ? "class='fonbol'" : "") ?>>
                                        ...
                                        <td <?= $khid ?>><?= $row->kode ?></td>
                                        <td><?= $row->nama ?></td>
                                        <td class="text-center" <?= $khid ?>><?= $row->nilai ?></td>
                                        <td class="text-center" <?= $khid ?>><?= ($row->setdef == '1' ? '<i class="fa fa-check-square-o"></i>' : '<i class="fa fa-square-o"></i>') ?></td>
