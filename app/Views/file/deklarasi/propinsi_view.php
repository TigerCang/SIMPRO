        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header <?= lang('app.bgList') ?>">
                    ...
                    <div class="job-badge"><?= "<a href='/propinsi/input' class='btn $btnclascr' $actcreate>$btntextcr</a>"; ?></div>
                </div>
                <!--  -->
                        ...
                        <table id="tabelawal" class="table table-striped table-hover nowrap">
                            <thead>
                                <tr class="bghead">
                                    ...
                                    <th scope="col"><?= lang('app.propinsi') ?></th>
                                        ...
                                        <td>
                                            <div class="dropdown-primary dropdown"><?= lang('app.btnDropdown') ?>
                                                <div class="dropdown-menu eddm dropdown-menu-right">
                                                    <a class="dropdown-item eddi" href="/propinsi/input/<?= $row->idunik ?>"><?= lang('app.detil') ?></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
