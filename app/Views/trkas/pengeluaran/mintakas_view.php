            ...
            <div class="card">
                ...
                <div class="card-block mt-2">
                    <div class="form-group row rownol">
                        ...
                        <span class="input-group-addon"><i class="icofont icofont-search-alt-2" aria-hidden="true" onclick="datamintakas()"></i></span>
                    </div>
                    <!--  -->
                    <div class="form-group row rownol">
                        ...
                        <div class="col-sm-1" <?= $filcek ?>>
                            <input type="checkbox" id="acc" name="acc" data-toggle="toggle" data-on="<?= lang('app.setuju') ?>" data-off="<?= lang('app.no') ?>" data-onstyle="primary" data-offstyle="light" <?= $tcek ?>>
                        </div>
                    </div>
                    <div class="dt-responsive table-responsive viewmintakas mt-2"></div>
                </div>
            </div>
        </div><!-- Akhir card-->
    ...
    function datamintakas() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('.viewmintakas').html(response.data);
            },
