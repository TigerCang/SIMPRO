        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block mt-2">
                    ...
                    <div class="form-group row" id="zsupir">
...
<script>
    ...
    function loadpilihan() {
        if (document.getElementById('pilihan').value === 'uangjalan') {
            $('#zsupir').removeAttr('hidden');
            $('#zbarang').attr('hidden', 'hidden');
        } else {
            $('#zbarang').removeAttr('hidden');
            $('#zsupir').attr('hidden', 'hidden');
        }
    }
