...
class Katalat extends BaseController
{
    ...
    {
        (!preg_match("/125/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_katalat"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-object-group ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-sitemap"></i>', 't_dir1' => lang("app.cabangaset"), 't_dir2' => lang("app.alat"), 't_dirac' => lang("app.katalat"), 't_link' => '/katalat',
            'menu' => 'katalat', 'khid' => 'hidden',
            'divisi' => $this->deklarModel->getDivisi('', 'katalat'),
    ...
    public function crany()
    {
        ...
        return redirect()->to('/katalat/input/' . $idu);
    }
    ...
    public function savedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $nama = $this->deklarModel->cekDivisi('katalat', $this->request->getVar('nama'), $this->request->getVar('idunik'));
