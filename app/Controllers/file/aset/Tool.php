...
class Tool extends BaseController
{
    ...
    {
        (!preg_match("/154/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_tool"), 't_submenu' => '',
            't_icon' => '<i class="icofont icofont-tools ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-sitemap"></i>', 't_dir1' => lang("app.cabangaset"), 't_dirac' => lang("app.tool"), 't_link' => '/tool',
            'menu' => 'tool', 'rhid' => 'hidden', 'pdhid' => '',
    ...
    public function crany()
    {
        ...
        return redirect()->to('/tool/input/' . $idu);
    }
    ...
    public function showdata($idunik)
    {
        ...
        $data = [
            't_menu' => lang("app.tt_tool"), 't_submenu' => '',
            't_icon' => '<i class="icofont icofont-tools ' . $ticon . '"></i>',
            't_diricon' => '<i class="fa fa-sitemap"></i>', 't_dir1' => lang("app.cabangaset"), 't_dirac' => lang("app.tool"), 't_link' => '/tool',
        ...
        return view('file/aset/tool_input', $data);
    }
    ...
    public function tabeldata()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = ['alat' => $this->deklarModel->getAlat($this->urls[1], '', 'tool', $perus, $div), 'rantkps' => '0001011', 'menu' => 'tool'];
