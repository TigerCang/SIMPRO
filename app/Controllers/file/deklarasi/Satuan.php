...
class Satuan extends BaseController
{
    ...
    {
        (!preg_match("/110/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_satuan"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-file ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-map-signs"></i>', 't_dir1' => lang("app.deklar"), 't_dirac' => lang("app.satuan"), 't_link' => '/satuan',
            'menu' => 'satuan', 'khid' => 'hidden',
            'divisi' => $this->deklarModel->getDivisi($this->urls[1], 'satuan'),
    ...
    public function crany()
    {
        ...
        return redirect()->to('/satuan/input/' . $idu);
    }
    ...
    public function savedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $nama = $this->deklarModel->cekDivisi('satuan', $this->request->getVar('nama'), $this->request->getVar('idunik'));
