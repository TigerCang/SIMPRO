...
class Wilayah extends BaseController
{
    ...
    {
        (!preg_match("/109/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_wilayah"), 't_submenu' => '',
            't_icon' => '<i class="icofont icofont-share ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-map-signs"></i>', 't_dir1' => lang("app.deklar"), 't_dirac' => lang("app.wilayah"), 't_link' => '/wilayah',
            'menu' => 'wilayah',
            'divisi' => $this->deklarModel->getDivisi($this->urls[1], 'wilayah'),
    ...
    public function crany()
    {
        ...
        return redirect()->to('/wilayah/input/' . $idu);
    }
