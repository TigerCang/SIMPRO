...
class Akunpajak extends BaseController
{
    ...
    {
        (!preg_match("/133/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_adpajak"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-file ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-balance-scale"></i>', 't_dir1' => lang("app.akuntansi"), 't_dirac' => lang("app.pajak"), 't_link' => '/akunpajak',
            'defakun' => $this->deklarModel->getDefakun($this->urls[1], 'pajak'),
            'menu' => 'akunpajak',  'shid' => 'hidden', 'khid' => '', 'phid' => 'hidden', 'nhid' => '',
    ...
    public function crany()
    {
        ...
        return redirect()->to('/akunpajak/input/' . $idu);
    }
    ...
    public function showdata($idunik)
    {
        ...
        $data = [
            ...
            'menu' => 'akunpajak',
            'selkel' => $this->deklarModel->distSelect('akunpajak', 't'),
            'selnama' => $this->deklarModel->distSelect('akunpajak'),
