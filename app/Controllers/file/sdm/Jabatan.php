...
class Jabatan extends BaseController
{
    ...
    {
        (!preg_match("/144/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_jabatan"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-file ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="icofont icofont-support"></i>', 't_dir1' => lang("app.sdm"), 't_dirac' => lang("app.jabatan"), 't_link' => '/jabatan',
            'menu' => 'jabatan', 'khid' => 'hidden',
            'divisi' => $this->deklarModel->getDivisi($this->urls[1], 'jabatan'),
    ...
    public function crany()
    {
        ...
        return redirect()->to('/jabatan/input/' . $idu);
    }
    ...
    public function savedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $nama = $this->deklarModel->cekDivisi('jabatan', $this->request->getVar('nama'), $this->request->getVar('idunik'));
