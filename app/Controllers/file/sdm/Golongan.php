...
class Golongan extends BaseController
{
    ...
    {
        (!preg_match("/145/i", $this->menu['menu_1'])) && throw \CodeIgniter\Security\Exceptions\SecurityException::forDisallowedAction();
        $data = [
            't_menu' => lang("app.tt_golongan"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-file ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="icofont icofont-support"></i>', 't_dir1' => lang("app.sdm"), 't_dirac' => lang("app.golongan"), 't_link' => '/golongan',
            'menu' => 'golongan', 'khid' => 'hidden',
            'divisi' => $this->deklarModel->getDivisi($this->urls[1], 'golongan'),
    ...
    public function crany()
    {
        ...
        return redirect()->to('/golongan/input/' . $idu);
    }
    ...
    public function savedata()
    {
        if ($this->request->isAJAX()) {
            ...
            $nama = $this->deklarModel->cekDivisi('golongan', $this->request->getVar('nama'), $this->request->getVar('idunik'));
