...
class Resetsandi extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            't_menu' => lang("app.tt_resetsandi"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-undo ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-user-secret"></i>', 't_dir1' => lang("app.admin"), 't_dirac' => lang("app.resetpass"), 't_link' => '/ulangsandi',
    ...
    public function resetdata()
    {
        if ($this->request->isAJAX()) {
            ...
            $this->logModel->saveLog('Reset', $this->request->getVar('id'), $username);
            $msg = ['sukses' => $username . ' => ' . lang("app.passreset")];
