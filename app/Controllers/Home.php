...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('home/dasbor_view', $data);
    }
    ...
    {
        $data = [
            't_menu' => lang("app.tt_userprofil"), 't_submenu' => '',
            't_icon' => '<i class="icofont icofont-business-man ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-home"></i>', 't_dir1' => lang("app.home"), 't_dirac' => lang("app.profil"), 't_link' => '/profile',
    ...
    {
        $data = [
            't_menu' => lang("app.tt_gantisandi"), 't_submenu' => '',
            't_icon' => '<i class="fa fa-unlock-alt ' . lang("app.xinput") . '"></i>',
            't_diricon' => '<i class="fa fa-home"></i>', 't_dir1' => lang("app.home"), 't_dirac' => lang("app.sandi"), 't_link' => '/sandi',
            'tuser' => $this->user, 'tmenu' => $this->menu,
        ];
    ...
    {
        $data = [
            't_menu' => lang("app.tt_aktifitas"), 't_submenu' => '',
            't_icon' => '<i class="icofont icofont-list ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-home"></i>', 't_dir1' => lang("app.home"), 't_dirac' => lang("app.aktifitas"), 't_link' => '/logdata',
