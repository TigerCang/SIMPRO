...
class Kasir extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            't_menu' => strtoupper(lang("app.kasir")), 't_submenu' => '',
            ...
            'menu' => 'kasir', 'baru' => 'hidden', 'filstat' => 'hidden', 'filcek' => '',
    ...
    public function showdata($idunik)
    {
        ...
        $data = [
            ...
            'kas' => $db1,
            'jeniskas' => $this->deklarModel->getKelAkun('kas', '', 'kas'),

            'anak' => $this->tranModel->getKasanak($db1[0]->id ?? ''),
            'sumanak' => $this->tranModel->getsumKasanak($db1[0]->id ?? ''),
        ...
        return view('trkas/pengeluaran/kasir_input', $data);
    }
