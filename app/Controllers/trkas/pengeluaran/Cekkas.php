...
class Cekkas extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            't_menu' => strtoupper(lang("app.tt_cekmintakas")), 't_submenu' => '',
            't_icon' => '<i class="fa fa-money ' . lang("app.xlist") . '"></i>',
            't_diricon' => '<i class="fa fa-money"></i>', 't_dir1' => lang("app.mintakas"), 't_dirac' => lang("app.tandat"), 't_link' => '/cekkas',
            'menu' => 'cekkas', 'baru' => 'hidden', 'filstat' => 'hidden', 'filcek' => '',
    ...
    public function showdata($idunik)
    {
        ...
        $data = [
            't_menu' => lang("app.tt_cekmintakas"), 't_submenu' => '',
        ...
        return view('trkas/pengeluaran/cekkas_input', $data);
    }
